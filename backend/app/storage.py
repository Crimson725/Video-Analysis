...
class MediaStore(Protocol):
    ...
    def upload_source_video(self, job_id: str, file_path: str, content_type: str) -> str:
...
def build_source_video_key(job_id: str) -> str:
    """Build the deterministic key for a source video object."""
    return f"jobs/{job_id}/input/source.mp4"
...
class R2MediaStore:
    ...
    def upload_source_video(self, job_id: str, file_path: str, content_type: str) -> str:
        object_key = build_source_video_key(job_id)
        self._upload_file(file_path, object_key, content_type)
        return object_key
